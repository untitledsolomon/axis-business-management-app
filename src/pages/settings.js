...
// Updated settings tab to use theme colors
...
export default function Settings() {
  ...
  return (
    // Re-added flex container for layout
    <div className="flex h-screen bg-[var(--secondary-bg)] font-inter">
      <Sidebar />
      <main className="flex-1 p-6 md:p-8 overflow-y-auto">
        {/* Use primary-text for heading */}
        <h1 className="text-2xl md:text-3xl font-bold text-[var(--primary-text)] mb-6">Settings</h1>
